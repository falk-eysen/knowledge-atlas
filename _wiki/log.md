...
- **Site navigation**: Kept source-only system docs and empty taxonomy folders out of the rendered Quartz Explorer; populated wiki sections now stay under `_wiki/` in the site build.
