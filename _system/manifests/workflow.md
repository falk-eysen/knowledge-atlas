...
The build does not emit compatibility alias folders. Quartz still exposes alias folders in Explorer, so clean navigation takes priority over old route compatibility.
